    ...
    <div class="cui-menu-left-scroll">
      <ul class="cui-menu-left-list cui-menu-left-list-root">
        <li class="cui-menu-left-item">
          <a href="sm-logistics-dashboard.html" class="cui-menu-right-action-toggle">
        ...
        <li class="cui-menu-left-item">
          <a href="sm-logistics-order-tracking-details.html">
            <span class="cui-menu-left-icon icmn-books"></span>
            <span class="cui-menu-left-title">Order Tracking</span>
          </a>
        </li>
        <li class="cui-menu-left-divider"><!-- --></li>
        <li class="cui-menu-left-item">
          <a href="sm-logistics-status.html">
            <span class="cui-menu-left-icon icmn-books"></span>
            <span class="cui-menu-left-title">Status</span>
          </a>
        </li>
...
<section class="card">
  <div class="card-header">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h4 class="text-black"><strong></strong><br/>
       <h5 style="color:#066;font-family:'Arial Black', Gadget"><strong>Create  Project</strong></h5>
    ...
    Save
      ...
      <p><strong>Note:Notification Will go to team members.</strong></p>
    </div>
    <table class="table table-hover table-bordered">
    <div><h4><strong>Display Task Search Site Code</strong></h4></div>
            <thead>
              <tr style="background-color:#06F;font-weight:bold">
   ...
   ;(function($) {
	...
	$('#datepicker-only-init1').datetimepicker({
	  ...
	  $('#datepicker-only-init5').datetimepicker({
	   ...
	   $('#datepicker-only-init8').datetimepicker({
        icons: {
          time: 'fa fa-clock-o',
          date: 'fa fa-calendar',
          up: 'fa fa-arrow-up',
	   ...
	   $('#datepicker-only-init9').datetimepicker({
        icons: {
          time: 'fa fa-clock-o',
          date: 'fa fa-calendar',
          up: 'fa fa-arrow-up',
