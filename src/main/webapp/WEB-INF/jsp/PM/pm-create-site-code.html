  ...
  <div class="card-header">
    ...
    <div class="row">
      <div class="col-lg-12">
       ...
       <h5 style="color:#066;font-family:'Arial Black', Gadget"><strong>Create Site Code</strong></h5>
            ...
            <thead>
              <tr style="background-color:#06F;font-weight:bold">
                <th><strong>Site Code</strong></th>
                   <th><strong>Site Name(Disteict:Block:Panchayat)</strong></th>
